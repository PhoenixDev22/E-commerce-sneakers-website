...
const form = document.querySelector(".btn-add");
...
if(input.value == 0){
    updateTheCartContentTtoEmpty();
    emptyShoppingCart();    
}else{
    updateTheCartContent();
}
...
// when you press on close icon closes the  bigger sized image with a lightbox
